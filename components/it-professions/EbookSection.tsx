      ...
      <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-[323px]">
        ...
        <div className="relative z-10">
          <Image
            src={mainImg}
            alt="Main Image"
            className="w-[290px] h-auto mx-auto"
          />
        ...
        <div className="flex-1 text-center md:text-left z-10">
          <h2 className="text-3xl md:text-4xl font-medium mb-8 text-black">
            Visit Our Free Programming Ebook, Study Material & Notes
          </h2>
          <a
            href="/study-materials"
            className="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold text-lg px-8 py-4 rounded-[22px] shadow-lg transition"
          >
