    ...
    <footer className="relative bg-[#c5d1ff] pt-16 pb-8 text-black">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-10">
        ...
        <div className="flex flex-wrap gap-4 text-sm ">
          <a href="#!" className="hover:underline bg-white">Best Web Development Courses in Delhi</a>
          <a href="#!" className="hover:underline bg-white">Python Training in Mumbai</a>
          <a href="#!" className="hover:underline bg-white">React.js Bootcamp in Pune</a>
          <a href="#!" className="hover:underline bg-white">Java Full Stack Courses in Hyderabad</a>
          <a href="#!" className="hover:underlin bg-whitee">UI/UX Design Classes in Chennai</a>
          <a href="#!" className="hover:underline bg-white">Android Development Courses Online</a>
        </div>
      </div>
