...
export default function StudyMaterialsSection() {
  return (
    <section className="relative w-full min-h-[600px] my-24 px-5 py-20 flex flex-col items-center justify-center text-center rounded-3xl bg-gradient-to-br from-orange-100/80 to-orange-50/90 shadow-lg overflow-hidden">
      ...
      {/* Background elements */}
      <div className="absolute inset-0 z-0 opacity-10 bg-[url('/assets/image/pattern.svg')] bg-repeat"></div>
      ...
      <div className="relative z-30 max-w-3xl p-10 bg-white/90 rounded-2xl shadow-lg backdrop-blur-md flex flex-col items-center gap-6">
        <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">
          Unlock Premium Study Resources
        </h2>
        <p className="text-lg text-gray-600 leading-relaxed">
          Access our extensive collection of free academic ebooks, study materials, and notes curated by top educators to boost your learning experience.
        </p>

        <a
          href="#"
          className="inline-flex items-center gap-3 px-10 py-4 rounded-full bg-gradient-to-r from-orange-500 to-orange-400 text-white font-semibold shadow-lg relative overflow-hidden hover:-translate-y-1 transition-all duration-300"
        >
